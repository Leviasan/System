...
namespace System.Data.Common
{
    ...
    public static class DbDataReaderExtensions
    {
        ...
        public static TReceive GetFieldValue<TReceive>(this DbDataReader reader, string name, TReceive defaultValue = default, IFormatProvider provider = default)
        ...
        /// <exception cref="OverflowException">When converting to Enum: value is outside the range of the underlying type of enumType.</exception>
        /// <typeparam name="TReceive">Type of data received.</typeparam>
        public static TReceive GetFieldValue<TReceive>(this DbDataReader reader, int ordinal, TReceive defaultValue = default, IFormatProvider provider = default)
            where TReceive : IConvertible
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));
        ...
        /// <exception cref="OverflowException">When converting to Enum: value is outside the range of the underlying type of enumType.</exception>
        /// <typeparam name="TReceive">Type of data received.</typeparam>
        public static Task<TReceive> GetFieldValueAsync<TReceive>(this DbDataReader reader, string name, TReceive defaultValue = default, IFormatProvider provider = default, CancellationToken cancellationToken = default)
            where TReceive : IConvertible
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));
        ...
        /// <exception cref="OverflowException">When converting to Enum: value is outside the range of the underlying type of enumType.</exception>
        /// <typeparam name="TReceive">Type of data received.</typeparam>
        public static async Task<TReceive> GetFieldValueAsync<TReceive>(this DbDataReader reader, int ordinal, TReceive defaultValue = default, IFormatProvider provider = default, CancellationToken cancellationToken = default)
            where TReceive : IConvertible
        {
            if (reader == null)
                throw new ArgumentNullException(nameof(reader));
