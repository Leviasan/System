...
namespace System.Data.Common
{
        ...
        where TReader : DbDataReader
    {
        ...
        int Execute<TRequest>(Type type, TRequest request);
        /// <summary>
        /// Asynchronously executes SQL statements.
        /// </summary>
        /// <param name="type">The type of the SQL statement.</param>
        /// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
        Task<int> ExecuteAsync(Type type, CancellationToken cancellationToken);
        /// <summary>
        /// Asynchronously executes SQL statements.
        /// </summary>
        /// <typeparam name="TRequest">The data type describing the input parameters.</typeparam>
        ...
        /// <param name="request">The request data.</param>
        /// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
        Task<int> ExecuteAsync<TRequest>(Type type, TRequest request, CancellationToken cancellationToken);
        /// <summary>
        ...
        /// <param name="type">The type of the SQL statement.</param>
        TResponse ExecuteReader<TResponse>(Type type);
        /// <summary>
        /// Executes SQL statements and reading the result data.
        /// </summary>
        /// <typeparam name="TRequest">The data type describing the input parameters.</typeparam>
        ...
        /// <param name="type">The type of the SQL statement.</param>
        /// <param name="request">The request data.</param>
        TResponse ExecuteReader<TRequest, TResponse>(Type type, TRequest request);
        /// <summary>
        ...
        /// <param name="type">The type of the SQL statement.</param>
        /// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
        Task<TResponse> ExecuteReaderAsync<TRequest, TResponse>(Type type, CancellationToken cancellationToken);
        /// <summary>
        /// Asynchronously executes SQL statements and reading the result data.
        /// </summary>
        /// <typeparam name="TRequest">The data type describing the input parameters.</typeparam>
        ...
        /// <param name="request">The request data.</param>
        /// <param name="cancellationToken">A token to cancel the asynchronous operation.</param>
        Task<TResponse> ExecuteReaderAsync<TRequest, TResponse>(Type type, TRequest request, CancellationToken cancellationToken);
    }
}
